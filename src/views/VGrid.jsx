...
import {LABEL_MODES, SELECT_MODES, GroupsContainer} from 'views/Groups.jsx';
import {SettingsContext, PythonContext, DataContext} from 'views/contexts.jsx';
    ...
    return (
      <div className='vgrid'>
        <Provider values={[
          ...
          [PythonContext, this.props.python]]}>
          <GroupsContainer jupyter={null} />
        </Provider>
      </div>
    );
  }
